class Rekening:
    ...
    __no_rekening = ""
    __pin = ""
    def __init__(self, nama, saldo, no_rekening, pin):
        self.__nama = nama
        self.__saldo = saldo
    ...
    def tarik_tunai(self, jumlah, pin=None):
        if pin != self.__pin:
...
Rek1 = Rekening("Budi", 1000000, "9876543210", "1234")
Rek1.cek_saldo("1234")
Rek1.top_up(500000, "1234")
Rek1.tarik_tunai(200000, "1234")
Rek1.tarik_tunai(1500000, "1234") 
